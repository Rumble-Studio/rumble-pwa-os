...
@Component({
	selector: 'rumble-pwa-export-paragraph-step',
	templateUrl: './export-paragraph-step.component.html',
	styleUrls: ['./export-paragraph-step.component.scss'],
})
export class ExportParagraphStepComponent {
	steptitle?: string;
